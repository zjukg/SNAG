...
class MformerFusion(nn.Module):
    ...
    def forward(self, embs):
        ...
        #     embs[i] += self.type_embedding(self.type_id[i])
        ...
        # joint_emb = hidden_states.reshape(bs, -1)
        # pdb.set_trace()
...
class MultiModalEncoder(nn.Module):
    ...
    def forward(self,
        ...
        joint_emb, hidden_states = self.fusion([img_emb, att_emb, rel_emb, gph_emb, name_emb, char_emb])
